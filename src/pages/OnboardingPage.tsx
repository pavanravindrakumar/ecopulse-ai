...
export default function OnboardingPage() {
  ...
  return (
    ...
    >
      ...
      {/* Progress */}
      <div className="w-full max-w-lg mb-6" role="progressbar" aria-valuenow={step} aria-valuemin={0} aria-valuemax={ONBOARDING_STEPS.length - 1} aria-label={`Step ${step + 1} of ${ONBOARDING_STEPS.length}`}>
